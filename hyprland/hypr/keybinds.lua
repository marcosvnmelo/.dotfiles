...
-- NOTE: Vicinae
hl.bind("Alt_l + SPACE", hl.dsp.exec_cmd(dmenu .. "vicinae://close || " .. uwsm .. dmenu .. "vicinae://open?popToRoot=true"))
...
-- Resize windows
hl.bind(ctrlMod .. " + l", hl.dsp.window.resize({ x = 30, y = 0, relative = true, window = { activewindow = true } }))
hl.bind(ctrlMod .. " + h", hl.dsp.window.resize({ x = -30, y = 0, relative = true, window = { activewindow = true } }))
hl.bind(ctrlMod .. " + k", hl.dsp.window.resize({ x = 0, y = -30, relative = true, window = { activewindow = true } }))
hl.bind(ctrlMod .. " + j", hl.dsp.window.resize({ x = 0, y = 30, relative = true, window = { activewindow = true } }))
